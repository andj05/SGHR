    ...
    public class HabitacionService : IHabitacionService
    {
        ...
        public async Task<OperationResult> GetById(int id)
        {
            ...
            try
            {
                ...
                result.Data = HabitacionMapper.ToDto(habitacion);
                result.Success = true;
            }
            catch (Exception ex)
            {
        ...
        public async Task<OperationResult> Restore(int id)
        {
            ...
            try
            {
                ...
                habitacion.RestoreFromDto(1); // en producción se debe obtener el id del usuario logueado
        ...
        public async Task<List<HabitacionDto>> ObtenerHabitacionesPorEstadoId(int idEstadoHabitacion)
        {
            try
            {
                ...
                return habitaciones.Where(h => !h.Deleted).Select(HabitacionMapper.ToDto).ToList();
            }
            catch (Exception ex)
            {
                _logger.LogError($"{_messageMapper.ErrorMessages["Generic"]["GenericError"]}: {ex}");
        ...
        public async Task<List<HabitacionDto>> ObtenerHabitacionesPorNumero(string numero)
        {
            try
            {
        ...
        public async Task<List<HabitacionDto>> ObtenerHabitacionesPorPisoId(int idPiso)
        {
            try
            {
                if (idPiso <= 0)
        ...
        public async Task<List<HabitacionDto>> ObtenerHabitacionesPorCategoriaId(int idCategoria)
        {
            try
            {
                if (idCategoria <= 0)
